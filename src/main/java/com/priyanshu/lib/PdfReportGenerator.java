...
//        _Image = new Image(ImageDataFactory.create(Base64.getDecoder().decode(Logo)))
...
//        _textDocument.add(_Image);
        ...
        table.addCell(new Cell().add(new Paragraph().add(
                new Text("Java Framework (" + _testReport.TestData.TestToolVersion + ")")
                        .addStyle(_fontTableRowDetails))));
        table.addCell(
